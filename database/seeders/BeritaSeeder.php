    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                ...
                'konten'  => '<p>Pemerintah Kabupaten Samosir terus mempercepat pembangunan infrastruktur penunjang pariwisata di kawasan Danau Toba. Sejumlah proyek strategis tengah berjalan, mulai dari pelebaran jalan lingkar Samosir, renovasi dermaga perahu di Tomok dan Tuk-Tuk, hingga pembangunan pusat informasi wisata terpadu di Ambarita.</p><p>Kepala Dinas Pariwisata Samosir menyebutkan bahwa anggaran sebesar Rp 45 miliar telah dialokasikan untuk pengembangan infrastruktur wisata tahun 2025. Prioritas utama adalah peningkatan akses jalan menuju objek wisata unggulan, pembangunan toilet umum berstandar, dan pemasangan jaringan WiFi publik di titik-titik wisata strategis.</p><p>Masyarakat setempat menyambut baik program ini dan berharap pembangunan infrastruktur dapat meningkatkan kunjungan wisatawan sekaligus membuka lapangan kerja baru bagi warga Samosir.</p>',
