...
class GaleriSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                'judul'       => 'Perahu Tradisional di Tuk-Tuk',
                'kategori'    => 'Wisata',
                'deskripsi'   => 'Perahu motor tradisional berjajar rapi di dermaga Tuk-Tuk, siap mengantarkan wisatawan menjelajahi keindahan Danau Toba.',
                'gambar'      => 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&q=80',
                'lokasi'      => 'Tuk-Tuk, Samosir',
                'tanggal_foto'=> '2025-04-05',
                'status'      => true,
            ],
            [
                'judul'       => 'Tenun Ulos Tradisional Ambarita',
                'kategori'    => 'Budaya',
            ...
            [
                'judul'       => 'Situs Batu Megalitik Ambarita',
                'kategori'    => 'Heritage',
                'deskripsi'   => 'Deretan kursi dan meja batu peninggalan Raja Laga Siallagan di Ambarita yang berusia ratusan tahun.',
