...
class GaleriGeositeSeeder extends Seeder
{
    ...
    {
        // Don't truncate 'galeri' here because GaleriSeeder has already run.
        // We only insert geosite images.

        $data = [
            // batu_hoda_beach
            [
                'judul'    => 'Sunrise di Batu Hoda Beach',
                'kategori' => 'landscape',
            ...
            [
                'judul'    => 'Perahu Tradisional Batu Hoda Beach',
                'kategori' => 'aktivitas',
            ...
            [
                'judul'    => 'Kehidupan Lokal Batu Hoda Beach',
                'kategori' => 'budaya',
            ...
            [
                'judul'    => 'Danau Toba dari Batu Hoda Beach',
                'kategori' => 'landscape',
            ...
            [
                'judul'    => 'Pertunjukan Sigale-Gale Batu Pasa Pantai',
                'kategori' => 'budaya',
            ...
            [
                'judul'    => 'Pasar Suvenir Batu Pasa Pantai',
                'kategori' => 'aktivitas',
            ...
            [
                'judul'    => 'Pemandangan Danau dari Batu Pasa Pantai',
                'kategori' => 'landscape',
            ...
            // museum_huta_bolon
            [
                'judul'    => 'Situs Megalitik Museum Huta Bolon',
                'kategori' => 'heritage',
            ...
            [
                'judul'    => 'Tenun Ulos Museum Huta Bolon',
                'kategori' => 'budaya',
            ...
            [
                'judul'    => 'Tepi Danau Museum Huta Bolon',
                'kategori' => 'landscape',
            ...
            [
                'judul'    => 'Nelayan Danau Toba Museum Huta Bolon',
                'kategori' => 'aktivitas',
        ...
        foreach ($data as $item) {
            $item['admin_id']   = 1;
            $item['lokasi']     = ucwords(str_replace('_', ' ', $item['geosite']));
            $item['created_at'] = now();
            $item['updated_at'] = now();
            DB::table('galeri')->insert($item);
        }

        $this->command->info('✅ GaleriGeositeSeeder: ' . count($data) . ' foto geosite berhasil ditambahkan ke tabel galeri.');
    }
}
