        ...
        @if(isset($informasiGeosite) && $informasiGeosite->count() > 0)
            ...
            <div class="sejarah-item {{ $loop->even ? 'reverse' : '' }}">
                <div class="sejarah-image">
                    ...
                    @else
                        <img src="/image/museum_huta/museum_huta_4.jpg" alt="{{ $info->judul }}">
                    @endif
                </div>
...
<section id="fasilitas" class="section bg-light">
    <div class="container">
        ...
        <div class="grid-3">
            ...
            <div class="card">
                @if($item->gambar)
                <img src="{{ $item->gambar_url }}" class="card-img" alt="{{ $item->nama }}" onerror="this.onerror=null;this.src='{{ asset('image/museum_huta/museum_huta.jpg') }}'">
                @endif
                <div class="card-content">
                    <h3>{{ $item->nama }}</h3>
                    <p>{{ $item->deskripsi }}</p>
    ...
    <div class="container">
        ...
        <div class="maps-section">
            <div class="maps-container">
                ...
                <iframe
                     src="{{ $detailGeosite?->maps_url ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3985.216058140516!2d98.74152767423692!3d2.7522539554657346!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3031b8ac44688e05%3A0xdb20e0beafe625bd!2sMuseum%20Huta%20Bolon%20Simanindo!5e0!3m2!1sid!2sid!4v1779111913624!5m2!1sid!2sid' }}"
                    width="100%"
                    height="450"
                    style="border:0;"
                    allowfullscreen=""
